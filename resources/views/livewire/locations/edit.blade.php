    ...
    <div class="col-md-6 mt-4">
        <div class="card">
            <div class="card-header bg-primary">
                <p class="card-title text-center"><i class="fa fa-cart-plus fa-2x"></i> Editer Location</p>
            </div>
            <form wire:submit.prevent = "updateLocation({{$location->id}})">
                @csrf
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" wire:model="editLocation.dateDebut" id="dateDebut" class="form-control @error("editLocation.dateDebut")is-invalid @enderror" placeholder="dateDebut" value="{{old('editLocation.dateDebut')}}"/>
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" wire:model="editLocation.dateFin" id="dateFin" class="form-control @error("editLocation.dateFin") is-invalid @enderror" placeholder="dateFin" value="{{old('editLocation.dateFin')}}"/>
                    ...
                    <div class="form-group">
                        <label for="statut_location_id">statut Location</label>
                        <select wire:model="editLocation.statut_location_id" id="statut_location_id" class="form-control @error("editLocation.statut_location_id")is-invalid @enderror">
                            <option value="">------------</option>
                    ...
                    <div class="form-group">
                        ...
                        <select wire:model="editLocation.client_id" id="client_id" class="form-control @error("editLocation.client_id")is-invalid @enderror">
                            <option value="">------------</option>
                                ...
                                <tr>
                                    <td class="">
                                        @if($article->estDisponible)
                                            <input class="form-check-input" wire:model='lesArticles.{{$article->id}}' type="checkbox" id="{{$article->id}}" name="{{$article->nom}}" value="{{$article->id}}" checked >
                                        @else
